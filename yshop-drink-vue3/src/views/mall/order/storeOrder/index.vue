<template>
  ...
  <ContentWrap>
    <el-button type="warning" @click="simNotifyVisible = true" class="mb-10px">模拟易宝支付回调</el-button>
    <!-- 搜索工作栏 -->
    <el-form
      class="-mb-15px"
      :model="queryParams"
  ...
  <SimYeepayNotify v-model="simNotifyVisible" />
</template>
...
import SimYeepayNotify from './SimYeepayNotify.vue'
...
const payStatus = ref('')
const simNotifyVisible = ref(false)
